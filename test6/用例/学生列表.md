...
|前置条件|学生，老师需要先登录|
|后置条件|显示出所有学生的信息表 |
|主事件流|1.系统显示出登录页面<br>2.老师/学生填写登录信息进入系统<br>3.选择查看学生信息<br>4.系统显示学生信息列表|
|备选事件流|2a.登录错误<br>&nbsp;&nbsp;&nbsp;&nbsp;1.系统提示登录错误，请重新输入|

## 2. 业务流程（顺序图） [源码](../src/sequence学生列表.puml)
![sequence1](../sequence学生列表.png) 

## 3. 界面设计
- 界面参照: https://d123456yy.github.io/is_analysis/test6/ui/index.html
- API接口调用
